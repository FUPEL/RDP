...
function layout_change(layout) {
  ...
  var logoSrc = isDark ? '../assets/images/LOGO_RDP-removebg-preview.png' : '../assets/images/LOGO_RDP-removebg-preview.png';
...
function layout_theme_sidebar_change(value) {
  if (value == 'true') {
    ...
    if (document.querySelector('.pc-sidebar .m-header .logo-lg')) {
      document.querySelector('.pc-sidebar .m-header .logo-lg').setAttribute('src', '../assets/images/LOGO_RDP-removebg-preview.png');
    }
