...
async function createUsersAndAssignRoles() {
  const usersToCreate = [
    {
      email: "BudiSanyata@rdp.com",
      password: "Direktur979905",
      role: "Direktur",
      display_name: "Budi Sanyata",
    },
    {
      email: "marketing@rdp.com",
      password: "marketing160208",
      role: "Marketing",
      display_name: "Marketing Team",
    },
    {
      email: "produksi@rdp.com",
      password: "produksi160208",
      role: "Produksi",
      display_name: "Produksi Team",
    },
  ]
  ...
  for (const user of usersToCreate) {
    try {
      ...
      // Insert or update profile with role and display_name
      ...
      if (profileError) {
        ...
        console.log(
          `Successfully created/updated user ${user.email} with role: ${user.role} and display name: ${user.display_name}`,
        )
      }
    } catch (error) {
